-- Info --
Allows you to easily use SteamOS repair image with Ventoy


-- Install --
-Download this Ventoy Addon
-Download the SteamOS Repair Image(.img format)
-make sure the SteamOS repair image has "repair" minus quotes in the filename
-Download the Ventoy Linux Installer from here(NOT the livecd.iso) 
...
-Run This:  Ventoy2Disk+SteamOS.sh
